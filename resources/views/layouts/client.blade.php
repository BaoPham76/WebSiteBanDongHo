                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="logo">
                        <a href="{{ route('user.home') }}">
                           <img src="{{ asset("asset/client/images/" . setting_website()->logo) }}" alt="WATCHSTYLE">
                           <h5>WATCHSTYLE</h5>
                        </a>
                     </div>
                  </div>
                  <div class="col-md-10 col-sm-10">
                     <div class="header_top">
                        <div class="row">
                           <div class="col-md-6">
                              <ul class="topmenu">
                                 <li><a href="https://www.facebook.com/a7pnb"><i class="fab fa-facebook"></i></a></li>
                                 ...
                                 <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                       <ul class="mega-menu-links">
                                          ...
                                          <li><a href="{{ route('order_history.index') }}">Đơn mua</a></li>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        ...
                        <p>
                           Chuyên bán đồng hồ. Tin cậy nhanh chóng. Chăm sóc khách hàng 24/24
                        </p>
                     </div>
                     <div class="col-md-3">
