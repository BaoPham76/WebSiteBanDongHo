            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Chào mừng đến với shop đồng hồ của chúng tôi - nơi cung cấp các sản phẩm đa dạng và chất lượng cao. Đến với chúng tôi để tìm kiếm phong cách của bạn!</p>
                    </div>
                ...
                <li class="animate-in">
                    ...
                    <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img src="{{ asset('asset/client/images/slider-image-02.png') }}" alt=""></div>
                </li>
                <li>
                    <div class="flat-caption caption2 formLeft delay400 text-center">
                        <h1>WATCH STYLE</h1>
                    ...
                    <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Luôn mang đến cho khách hàng sản phẩm chất lượng tốt nhất</p>
                    </div>
